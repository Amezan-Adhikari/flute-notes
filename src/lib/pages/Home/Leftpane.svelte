<script>
    ...
    const topSongsAllTime = [
        { id: 1, title: "Bohemian Rhapsody", artist: "Queen", plays: 35600 },
        { id: 2, title: "Shape of You", artist: "Ed Sheeran", plays: 32400 },
        { id: 3, title: "Despacito", artist: "Luis Fonsi ft. Daddy Yankee", plays: 31200 },
        { id: 4, title: "Tum Hi Ho", artist: "Arijit Singh", plays: 29800 },
        { id: 5, title: "Believer", artist: "Imagine Dragons", plays: 28500 }
    ];
</script>
<div class="hidden md:flex md:w-72 lg:w-80 bg-gray-50 flex-col p-6 border-r border-gray-200 h-screen overflow-y-auto">
    <!-- Categories Section -->
    <div class="mb-8">
        <h2 class="font-[poppins] text-xl font-semibold mb-4 text-gray-800">Categories</h2>
                ...
                <a href="/{category.slug}" class="flex items-center p-3 rounded-lg hover:bg-white hover:shadow-sm transition-all duration-200 cursor-pointer group">
                    <div class="w-10 h-10 rounded-full flex items-center justify-center mr-3" style="background-color: {category.color}20; color: {category.color};">
                        ...
                        {#if category.icon_name === "help-buoy-outline"}
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 512 512" fill="none" stroke="currentColor" stroke-width="32" stroke-linecap="round" stroke-linejoin="round">
                                <circle cx="256" cy="256" r="208"/>
                                <circle cx="256" cy="256" r="80"/>
                                <path d="M208 54l8 132M296 186l8-132M208 458l8-132M296 326l8 132M458 208l-132 8M186 296l-132 8M458 304l-132-8M186 216l-132-8"/>
                            </svg>
                        {/if}
                    </div>
                    <div class="flex-1">
                        <h3 class="font-[poppins] font-medium text-gray-900 group-hover:text-gray-900">{category.title}</h3>
    ...
    <div class="mb-8">
        <div class="bg-gray-100 rounded-lg p-4 text-center">
            ...
            <div class="bg-gray-200 h-32 flex items-center justify-center rounded border border-gray-300">
